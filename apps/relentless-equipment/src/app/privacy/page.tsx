  ...
  return (
    <section className="container-yard py-20 md:py-28 max-w-3xl">
      ...
      <p className="text-carbon-600 leading-relaxed">
        {BRAND.name} collects information you submit through availability forms — name, contact details, and job notes — solely to respond to your request and deliver our services. We do not sell or share this information with third parties for marketing purposes.
      </p>
