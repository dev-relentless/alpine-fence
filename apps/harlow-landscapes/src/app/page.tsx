        ...
        <div className="relative container-editorial py-20 md:py-40">
          ...
          <Reveal delay={100}>
            <p className="font-display text-2xl sm:text-3xl md:text-4xl text-stone-800 max-w-3xl mx-auto text-center leading-snug tracking-display-tight">
              Two disciplines held in one firm. The hand and the ground. What the eye keeps, and what the earth holds.
            </p>
          </Reveal>
          ...
          <div className="mt-14 md:mt-24 grid lg:grid-cols-[1fr_auto_1fr] gap-8 md:gap-10 lg:gap-16 items-stretch">
            <Reveal delay={150}>
              <article className="relative h-full p-8 sm:p-10 md:p-14 border border-stone-200 bg-ivory-100/60">
                ...
                <div className="eyebrow text-bronze-500 mb-5 md:mb-6">The Hand</div>
                ...
                <p className="text-stone-700 leading-relaxed text-base md:text-lg max-w-md">
                  Refinement, proportion, restraint. The hand is the design intelligence of the firm — the way a wall meets the architecture, the cadence of light across a terrace, the quiet edit that keeps a property feeling inevitable instead of arranged.
                </p>
            ...
            <Reveal delay={350}>
              <article className="relative h-full p-8 sm:p-10 md:p-14 border border-stone-200 bg-stone-900 text-ivory-50">
                ...
                <div className="eyebrow text-bronze-300 mb-5 md:mb-6">The Ground</div>
                ...
                <p className="text-ivory-100/85 leading-relaxed text-base md:text-lg max-w-md">
                  Strength, legacy, the part you don&rsquo;t see. Beneath every landscape is the engineering — base preparation, drainage, footings, structural walls, and honest materials specified to outlive the people who commissioned them.
                </p>
      ...
      <section className="relative bg-stone-950 text-ivory-50 overflow-hidden">
        ...
        <div className="relative container-editorial py-20 md:py-32 grid lg:grid-cols-12 gap-10 md:gap-12">
          ...
          <div className="lg:col-span-7 lg:pl-10 lg:border-l border-ivory-50/15">
            <div className="eyebrow text-ivory-100/55 mb-5 md:mb-6">Harlow Landscapes is for —</div>
            {[
              {
                n: '01',
