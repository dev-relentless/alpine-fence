  ...
  return (
    <section className="container-slab py-20 md:py-28 max-w-3xl">
      ...
      <p className="text-iron-600 leading-relaxed">
        Use of this site is provided as-is. Projects are governed by the written bid and contract executed between {BRAND.name} and the customer, including scope, specifications, pricing, and change-order terms. Content on this site is the property of {BRAND.name}.
      </p>
    </section>
  );
}
