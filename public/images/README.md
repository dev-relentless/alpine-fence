# Alpine Fence & Deck — Image Assets

Drop your photos into the appropriate folders below. Use the exact filenames listed so they match the website code.
...
├── logo.png                  ← Logo fallback (used in schema markup)
...
│   ├── ranch-rail.jpg
│   ├── board-on-board.jpg
│   ├── lattice-top-privacy.jpg
│   └── multi-level-deck.jpg
│
...
|-------|------|--------|-------|
| **logo.svg** | Any (vector) | SVG | Transparent background |
| **logo.png** | 400×100+ | PNG | Transparent bg, for schema/fallback |
| **og-image.jpg** | 1200×630 | JPG | Social media preview card |
...
| **testimonials/*.jpg** | 200×200 | JPG | Square crop, faces |
| **badges/*.svg** | Any (vector) | SVG | Transparent background |

---

## ✅ Total Photos Needed: ~30

### Critical (site looks broken without these)
- [ ] `logo.svg` / `logo.png`
- [ ] `og-image.jpg`
- [ ] `hero.jpg`

### High Priority (key pages are placeholder-only)
- [ ] 8 gallery project photos
- [ ] 6 design style previews
